...
import { Dices, Gamepad2, LogIn, LogOut, Settings, SquarePen, User, } from 'lucide-react'
  ...
  return (
    <div className='navbar bg-base-200'>
        <div className='navbar-start'>
            <a href='/' className='btn btn-ghost hover:bg-base-100'><Gamepad2/>Home</a>
        </div>
        <div className='navbar-center hidden lg:flex'>
            <ul className='menu menu-horizontal px-1'>
                ...
                <li><a href='/Backgammon'><Dices size={20}/>Backgammon</a></li>
                <li><a href='/Chess'>
