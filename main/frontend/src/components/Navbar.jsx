...
import { Dices, Gamepad2, Joystick, LogIn, LogOut, SquarePen, User, Users } from 'lucide-react'
    ...
    <div className='navbar bg-base-200'>
        ...
        <div className='navbar-end'>
            <div className='dropdown dropdown-hover'>
                ...
                {auth ? 
                    <li><a><LogOut size={20}/>Logout</a></li>:
                    <li><a><LogIn size={20}/>Login</a></li>
                }
                {auth ? 
                    null:
                    <li><a><SquarePen size={20}/>Signup</a></li>
                }
                </ul>
            </div>
        </div>
